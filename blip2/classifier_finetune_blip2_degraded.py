...
BASE = "/home/hice1/dkwon70/scratch/dl-project"

DATAPATH = os.path.join(BASE, "data_preprocessed_blip2")
TRAIN_PATH = os.path.join(DATAPATH, f"train_{args.level}")
VAL_PATH   = os.path.join(DATAPATH, f"validation_{args.level}")
...
output_root = os.path.join(BASE, "blip2-finetuned")
level_dir = os.path.join(output_root, args.level)
os.makedirs(level_dir, exist_ok=True)

run_dir = os.path.join(level_dir, timestamp)
